...
```bash
# Clone repository
git clone https://github.com/eliashaeussler/typo3-config-objects.git
cd typo3-config-objects
...
Once the changes are ready, please [submit a pull request](https://github.com/eliashaeussler/typo3-config-objects/compare)
