...
/**
 * IconSourceOptionIsMissing.
 *
 * @author Elias Häußler <elias@haeussler.dev>
 * @license GPL-2.0-or-later
 */
final class IconSourceOptionIsMissing extends Exception
{
    public function __construct()
    {
        parent::__construct(
            sprintf('The configured icon provider requires an icon source to be present.'),
            1744789796,
        );
    }
}
